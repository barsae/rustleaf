...
use rustleaf_macros::rust_value_any;
...
/// Vector2Ref wraps Rc<RefCell<Vector2>> and implements RustValue - this entire type could be generated by a proc macro
#[derive(Debug, Clone)]
...
// RustLeaf wrapper methods - this entire impl could be generated by a proc macro
impl Vector2Ref {
    // RustLeaf wrapper methods using our ergonomic primitives
