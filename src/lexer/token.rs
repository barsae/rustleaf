...
pub enum Token {
    ...
    Ident(String),
    Var, Fn, If, Else, While, For, Loop, Return, Break, Continue,
    Class, Static, Self_, Super, Import, Export, As, From,
    Match, Case, Try, Catch, Finally, With,
    And, Or, Xor, Not, In, Is, Pub, Raise, Use,
    ...
    Comma, Semicolon, Dot, Colon, DoubleColon,
